...
function downloadHasil() {
  ...
  const pretest = document.getElementById("pretestFile");
  const filename = pretest.files[0].name;
  const kelasMatch = filename.match(/-([A-Z])-Pretest/i);
  const kelas = kelasMatch ? kelasMatch[1] : "Unknown";
